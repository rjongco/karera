    ...
    <Grid container direction="column">
      ...
      <Grid item sx={{ mt: 1 }}>
        <Autocomplete
          ...
          onBlur={() => {
            handleBlur("permanentAddresses.provinceId");
          }}
          //  @ts-ignore
          ...
          renderInput={(params) => (
            <TextField
              ...
              error={
                errors?.permanentAddresses?.provinceId &&
                touched?.permanentAddresses?.provinceId
              }
              helperText={
                errors?.permanentAddresses?.provinceId &&
                touched?.permanentAddresses?.provinceId
      ...
      <Grid item sx={{ mt: 2 }}>
        <Autocomplete
          ...
          onBlur={() => {
            handleBlur("permanentAddresses.cityId");
          }}
          //  @ts-ignore
          getOptionLabel={(option) => option?.name}
          renderInput={(params) => (
            <TextField
              ...
              error={
                errors?.permanentAddresses?.cityId &&
                touched?.permanentAddresses?.cityId
              }
              helperText={
                errors?.permanentAddresses?.cityId &&
                touched?.permanentAddresses?.cityId
                  ? errors?.permanentAddresses?.cityId
                  : userProfileState.errorMessage
                  ? userProfileState.errorMessage["permanentAddresses.cityId"]
                  : ""
              }
            />
          )}
      ...
      <Grid item sx={{ mt: 2 }}>
        <TextField
          ...
          onChange={(e) => {
            ...
            setFieldValue("permanentAddresses.street", uppercaseValue);
          }}
          onBlur={() => {
            handleBlur("permanentAddresses.street");
          }}
          error={
            errors?.permanentAddresses?.street &&
            touched?.permanentAddresses?.street
          }
          helperText={
            errors?.permanentAddresses?.street &&
            touched?.permanentAddresses?.street
              ? errors?.permanentAddresses?.street
              : userProfileState?.errorMessage
              ? userProfileState?.errorMessage["permanentAddresses.street"]
              : ""
          }
        />
      </Grid>
      <Grid item sx={{ mt: 2 }}>
        <TextField
          ...
          variant="standard"
          onChange={(e) => {
            setFieldValue("permanentAddresses.zipCode", e.target.value);
          }}
          onBlur={() => {
            handleBlur("permanentAddresses.zipCode");
          }}
          error={
            errors?.permanentAddresses?.zipCode &&
            touched?.permanentAddresses?.zipCode
          }
          helperText={
            errors?.permanentAddresses?.zipCode &&
            touched?.permanentAddresses?.zipCode
              ? errors?.permanentAddresses?.zipCode
              : userProfileState?.errorMessage
              ? userProfileState?.errorMessage["permanentAddresses.zipCode"]
              : ""
          }
        />
      </Grid>
